...
public class AdminController {
	...
	public RedirectView createEspacioFinal(@ModelAttribute("espacio") Espacio espacio, @ModelAttribute("notaPedidoFinal") NotaPedidoFinalModel notaPedidoFinalModel) {
